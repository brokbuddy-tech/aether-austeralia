...
export default function PropertyStory({ story }: PropertyStoryProps) {
  ...
  const maxLength = 600; // Character limit for the truncated view
  ...
  return (
    <div className="mb-16">
      ...
      <div className="prose max-w-none text-gray-600 leading-relaxed font-body text-xs whitespace-pre-wrap transition-all duration-300">
        {displayedStory}
      </div>
      {shouldTruncate && (
        <Button 
          ...
          className="p-0 h-auto mt-4 text-[9px] font-bold tracking-[0.3em] uppercase text-primary hover:no-underline hover:text-[#111111] transition-colors"
        >
