    ...
    <div className="pt-[72px] bg-white min-h-screen">
      ...
      <section className="relative h-[50vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-6">
          <span className="text-white/80 font-bold text-[10px] tracking-[0.4em] mb-4 block uppercase">Our Heritage</span>
          <h1 className="font-headline font-extrabold text-4xl md:text-6xl mb-6 tracking-tighter text-white uppercase leading-none">
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="font-headline font-extrabold text-3xl md:text-4xl tracking-tighter uppercase leading-[1.1] mt-6 mb-8">
              Redefining the <br /><span className="text-gray-300">Australian standard.</span>
            </h2>
            <div className="space-y-5 text-gray-500 font-body text-base leading-relaxed">
              <p>
          ...
          <div className="relative aspect-square overflow-hidden shadow-2xl group">
            ...
            />
            <div className="absolute inset-0 border-[15px] border-white/10 m-5 pointer-events-none" />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-[#F5F7FA]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="font-headline font-extrabold text-3xl mb-4 text-[#111111] uppercase tracking-tighter">THE AETHER STANDARD</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            {[
              ...
              <div key={idx} className="bg-white p-8 border border-gray-100 shadow-sm text-center group hover:shadow-lg transition-all">
                <div className="mb-5 flex justify-center">{item.icon}</div>
                <h3 className="font-headline font-bold text-base mb-3 tracking-widest">{item.title}</h3>
      ...
      {/* Team CTA */}
      <section className="py-24 bg-[#111111] text-white text-center px-6 relative overflow-hidden">
        ...
        <div className="relative z-30">
          <h2 className="font-headline font-extrabold text-3xl md:text-5xl mb-6 uppercase tracking-tighter">MEET THE SPECIALISTS</h2>
          <p className="text-gray-400 max-w-xl mx-auto mb-10 text-base font-body">
