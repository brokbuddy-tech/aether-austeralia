const CATEGORY_TERMS: Record<string, string[]> = {
  ...
  Retail: ['retail', 'shop', 'shops'],
  Warehouse: ['warehouse', 'warehouses'],
  Industrial: ['industrial', 'factory', 'factories', 'warehouse', 'warehouses'],
  Medical: ['medical', 'consulting', 'clinic', 'clinics'],
  Showroom: ['showroom', 'showrooms'],
  Development: ['development', 'developments', 'development site', 'development sites'],
};
...
export function normalizeCategory(value?: string | null) {
  ...
  if (!cleaned || cleaned === 'any' || cleaned === 'all') return undefined;
