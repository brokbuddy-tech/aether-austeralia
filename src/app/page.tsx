      ...
      <div className="relative z-20 bg-white">
        ...
        <section className="py-24 px-6 bg-[#F5F7FA]">
          <div className="max-w-7xl mx-auto">
            <div className="flex justify-between items-end mb-12">
              <div>
                <h2 className="font-headline font-extrabold text-4xl mb-4 text-[#111111]">FEATURED RESIDENCES</h2>
        ...
        <section className="py-24 px-6 bg-white border-t border-gray-100">
          <div className="max-w-7xl mx-auto">
            <div className="flex justify-between items-end mb-12">
              <div>
                <h2 className="font-headline font-extrabold text-4xl mb-4 text-[#111111]">NEW LISTINGS</h2>
            ...
            <div>
              ...
              <div className="space-y-6 mb-12">
                <div className="flex gap-4 items-start">
                  ...
                  <p className="text-sm font-bold pt-3 tracking-wide uppercase">QUARTERLY MARKET REPORTS</p>
                </div>
                <div className="flex gap-4 items-start">
                  ...
                  <p className="text-sm font-bold pt-3 tracking-wide uppercase">LOCAL SUBURB PROFILES</p>
                </div>
                <div className="flex gap-4 items-start">
                  ...
                  <p className="text-sm font-bold pt-3 tracking-wide uppercase">INVESTOR STRATEGY GUIDES</p>
                </div>
              </div>
              <Link href="/insights">
                <Button className="bg-primary hover:bg-primary/90 text-white font-bold h-14 px-10 rounded-none uppercase tracking-widest text-xs">
